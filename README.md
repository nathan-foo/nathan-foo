...
- TypeScript (Frontend + Backend with React.js, Next.js, etc.)
- JavaScript (Frontend + Backend with React.js, Node.js, Express, etc.)
- Python (Backend with Flask, FastAPI, etc.)
- Go (Backend)
- C/C++ (Systems)
- Java (Backend)
- HTML/CSS (Frontend)
...
#### I'm also experienced in these frameworks and libraries:
...
#### I'm skilled in the following, but not limited to, developer tools:
